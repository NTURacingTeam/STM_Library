...
/*Editor: 黃柏瑞      */
//————————————————
//本文为CSDN博主「Zach_z」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//原文链接：https://blog.csdn.net/Zach_z/article/details/71511876
/**********************/
...
// SPI(NRF24L01) Regester Configeration
#define CONFIG \
...
#define STATUS \
    0x07             //状态寄存器;bit0:TX FIFO满标志;bit3:1,接收数据通道号(最大:6);bit4,达到最多次重发
