...
void DMA_ADC1_DMA_Init() {
    ...
    DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable;             //³]©w¥~³]¦a§}±H¦s¾¹»¼¼W»P§_,¦¹³B³]¬°¤£ÅÜ
                                                                                 // Disable
    ...
    DMA_InitStructure.DMA_Priority = DMA_Priority_High;                          // DMA³q¹D¾Ö¦³°ªÀu¥ý¯Å ¤À§O4­Óµ¥¯Å
                                                                                 // §C¡B¤¤¡B°ª¡B«D±`°ª
...
u16* DMA_ADC1_get_address() { return ADCConvertedValue; }
