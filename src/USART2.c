...
char USART2_Get_Buffer(void) {
    ...
    Buff_Get_Index++;
    if (Buff_Get_Index > Buff_Size) Buff_Get_Index = 0;
    if (Buff_Put_Index == Buff_Get_Index) {
        Buff_Get_Index--;
        if (Buff_Get_Index < 0) Buff_Get_Index = Buff_Size;
    }
...
void USART2_Put_Buffer(char c) {
    ...
    Buff_Put_Index++;
    if (Buff_Put_Index > Buff_Size) Buff_Put_Index = 0;
    if (Buff_Put_Index == Buff_Get_Index) Buff_Get_Index++;
}
